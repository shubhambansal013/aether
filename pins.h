...
const int PM_SENSOR_SET_PIN = 12; // GPIO 12 (D6) -> Connected to Sensor SET (Wake/Sleep)

// --- RGB LED Pins (Common Cathode) ---
// Note: D8 (GPIO 15) MUST have a 10k Pull-down to GND for the ESP8266 to boot.
const int RGB_LED_RED_PIN   = 13; // GPIO 13 (D7)
const int RGB_LED_GREEN_PIN = 15; // GPIO 15 (D8)
const int RGB_LED_BLUE_PIN  = 0;  // GPIO 0  (D3) - Moved here to free up D6 for Sensor SET
